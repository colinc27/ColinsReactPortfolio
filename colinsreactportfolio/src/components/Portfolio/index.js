      ...
      <div class="row col-12">
        <div class="card mx-auto my-3" id="Portfolio">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              This was a group project where we developed a simple budgeting app
              using the MERN stack. We could not get it deployed unfortunately
              but it will work if it is ran locally.
            </p>
            <a
        ...
        <div class="card mx-auto my-3" id="Portfolio">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              This was a group project where we developed a website where you
              can track crypto and stock data. While it may not be the best
              website in the world it was my first full website. I used JS,
              HTML, CSS, and third party APIS
            </p>
            <a
              href="https://github.com/colinc27/BillionDollarBudget"
              class="btn btn-primary"
        ...
        <div class="card mx-auto my-3" id="Portfolio">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              This was a group project where we developed a working app where
              you can make a teacher or student login. The students take a test
              which evaluates their understanding of the alphabet. The teachers
              are taken to a dashboard where they can see their student's score.
              This project uses SQL, Node, JS, HTML, CSS, JS and more!
            </p>
            <a
        ...
        <div class="card mx-auto my-3" id="Portfolio">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              This app allows the user to use console commands to create a
              custom professional readme MD file without all the MD file coding.
              Checkout the video link for an explanation of how it works.
            </p>
            <a
        ...
        <div class="card mx-auto my-3" id="Portfolio">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              functionality to it. The base is separate from the body and sits
              on a bearing that allows the entire body to spin. It also has a
              hidden compartment in the middle that holds the tips, tools, and
              flights.
            </p>
            <a
        ...
        <div class="card mx-auto my-3" id="Portfolio">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              store their mouse and 2 usb drives. It uses gravity to sit
              attached to the table and can be picked up and moved very easily.
            </p>
            <a
        ...
        <div class="card mx-auto my-3" id="Portfolio">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              different color materials. Unfortunately, I no longer have access
              to the models as this was a project I created using another
              software.
            </p>
            <button
              type="button"
